                    ...
                    <div className="row">
                      ...
                      <div className="col-3 mt-3">
                        ...
                        <select
                          ...
                          id="idCategoria"
                          value={(values.idCategoria = categoriaSeleccionada)}
                          onChange={(e) => {
                        ...
                        >
                          ...
                          {categoria.map((categoria, e) => (
                            <option key={e} value={categoria.idcat}>
                              {categoria.nombre}
                            </option>
                          ))}
                        </select>
                      ...
                      <div className="col-3 mt-3">
                        ...
                        <select
                          className="form-select"
                          id="idCategoria"
                          value={(values.idMat = materialSeleccionado)}
                          onChange={(e) => {
                        ...
                        >
                          ...
                          {material.map((material, e) => (
                            <option key={e} value={material.idcat}>
                              {material.nombre}
                            </option>
                          ))}
                        </select>
                      ...
                      <div className="col-md-12 my-4">
                        <button id="" className="btn btn-success duplicate">
                          Agregar fila <i className="fa fa-plus"></i>
                        </button>
                      </div>
                    </div>
                  </div>
